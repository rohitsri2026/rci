    ...
    <div className="p-6 sm:p-8 space-y-7 max-w-7xl mx-auto selection:bg-blue-500 selection:text-white">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200/90 pb-5">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-extrabold text-slate-900 tracking-tight">
                Notification History & Log Center
              </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={fetchLogs}
            disabled={loading}
            className="h-10 px-3.5 inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 font-extrabold text-xs transition-colors shadow-2xs disabled:opacity-50"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-emerald-200/90 p-4 space-y-1 shadow-2xs">
          ...
          <p className="text-2xl font-extrabold text-emerald-800">{whatsappCount}</p>
        </div>
        <div className="bg-white rounded-2xl border border-blue-200/90 p-4 space-y-1 shadow-2xs">
          ...
          <p className="text-2xl font-extrabold text-blue-800">{smsCount}</p>
        </div>
        <div className="bg-white rounded-2xl border border-indigo-200/90 p-4 space-y-1 shadow-2xs">
          ...
          <p className="text-2xl font-extrabold text-indigo-800">{sentCount}</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center space-y-3">
            ...
            <p className="text-sm font-extrabold text-slate-700">No Notification Logs Found</p>
                      ...
                      <td className="py-3.5 px-4 text-right">
                        {!isSent ? (
                          <button
                            ...
                            className="px-2.5 py-1 text-[11px] font-extrabold text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg transition-colors disabled:opacity-50"
                          >
