        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            <p className="text-slate-600 text-base sm:text-lg leading-relaxed mb-6">
              Rohit Computer Institute (RCI) was established with a singular mission: to make high-quality, job-oriented computer education accessible to every aspiring student. We bridge the gap between academic theory and practical industry requirements.
            </p>
            ...
            <div className="bg-white border-l-4 border-blue-600 p-6 rounded-r-2xl border-y border-r border-slate-200/80 shadow-xs mb-7 relative">
              ...
              <p className="text-slate-800 italic text-sm sm:text-base leading-relaxed font-medium relative z-10">
                &ldquo;Our focus is building genuine confidence in our students. We believe technology education is not just about passing exams, but mastering practical computer skills that unlock career opportunities.&rdquo;
              </p>
              <div className="mt-4 flex items-center gap-2 text-xs">
                <span className="font-extrabold text-slate-900">— {RCIConfig.directorName}</span>
                <span className="text-slate-300">|</span>
                <span className="text-blue-600 font-bold">{RCIConfig.directorTitle}</span>
              </div>
            </div>
