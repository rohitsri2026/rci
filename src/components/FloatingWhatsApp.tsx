...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="hidden sm:flex fixed bottom-8 right-8 z-40 bg-emerald-500 hover:bg-emerald-600 text-white p-3.5 sm:p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 items-center justify-center group"
    >
